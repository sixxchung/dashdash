...
from . import example_plots #import plot_pie, plot_surface, plot_scatter
...
content = dac.TabItem(id='content_cards',
            ...
            [
                ...
                dac.Box(
                    [
                    	...
                    	dac.BoxBody(
                            dcc.Graph(
                                figure=example_plots.plot_surface(),
                                config=dict(displayModeBar=False),
                                style={'width': '38vw'}
                            )
                        )		

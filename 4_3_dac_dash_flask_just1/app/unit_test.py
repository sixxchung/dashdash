...
myModule = 'basic_boxes'

import importlib
view = importlib.import_module(f'dashPages.{myModule}.view')
callbacks = importlib.import_module(f'dashPages.{myModule}.callbacks')
model = importlib.import_module(f'dashPages.{myModule}.model')
